...
const ContactMe = () => {
  ...
  const socialLinks = [
    { icon: FiGithub, href: "https://github.com/tu-usuario", label: "GitHub" },
    { icon: FiLinkedin, href: "https://linkedin.com/in/tu-perfil", label: "LinkedIn" },
    { icon: FiTwitter, href: "https://twitter.com/tu-usuario", label: "Twitter" },
  ];
      ...
      <div className="max-w-4xl w-full">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-white">
            Hablemos del <span className="text-violet-400">próximo proyecto</span>
          </h2>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 text-gray-300">
                  ...
                  <div>
                    ...
                    <p className="text-sm">tu.email@ejemplo.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 text-gray-300">
                  ...
                  <div>
                    ...
                    <p className="text-sm">Dentro de 24 horas</p>
                  </div>
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-12 pr-4 py-3 bg-gray-900/50 border rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 transition-all ${
                        errors.name 
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      rows={5}
                      className={`w-full pl-12 pr-4 py-3 bg-gray-900/50 border rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 transition-all resize-none ${
                        errors.message 
                          ? 'border-red-500 focus:ring-red-500/20' 
                          : 'border-gray-600 focus:border-violet-500 focus:ring-violet-500/20'
                      }`}
